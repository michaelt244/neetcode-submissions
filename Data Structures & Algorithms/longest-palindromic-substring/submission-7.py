    ...
    def longestPalindrome(self, s: str) -> str:
        ...
        for i in range(len(s)):
            ...
            while (0 <= l and r < len(s) and s[l] == s[r] ):
                ...
                r += 1
            odd_attempt = s[l + 1: r] 
            odd_attempt_len = len(odd_attempt)
            ...
            while (0 <= l and r < len(s) and s[l] == s[r]):
                l -= 1
                r += 1
            even_attempt = s[l + 1: r] 
            even_attempt_len = len(even_attempt)

            if even_attempt_len > longest_len:
                longest_palindrome = even_attempt
                longest_len = even_attempt_len
            if odd_attempt_len > longest_len:
                longest_palindrome = odd_attempt
                longest_len = odd_attempt_len
